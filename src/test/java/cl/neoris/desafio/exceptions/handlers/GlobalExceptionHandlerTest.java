...
class GlobalExceptionHandlerTest {
    ...
    void testHandleEmailAlreadyExistsException() {
        ResponseEntity<Map<String, String>> actualHandleEmailAlreadyExistsExceptionResult = globalExceptionHandler
                .handleEmailAlreadyExistsException(new EmailAlreadyExistsException("An error occurred"));
        ...
        assertEquals(409, actualHandleEmailAlreadyExistsExceptionResult.getStatusCode().value());
        assertEquals(HttpStatus.CONFLICT, statusCode);
        assertTrue(actualHandleEmailAlreadyExistsExceptionResult.hasBody());
        assertTrue(actualHandleEmailAlreadyExistsExceptionResult.getHeaders().isEmpty());
    }
    ...
    void testHandleEmailAlreadyExistsException2() {
        ...
        ResponseEntity<Map<String, String>> actualHandleEmailAlreadyExistsExceptionResult = globalExceptionHandler
                .handleEmailAlreadyExistsException(ex);
    ...
    void testHandleInvalidTokenException() {
        ResponseEntity<Map<String, String>> actualHandleInvalidTokenExceptionResult = globalExceptionHandler
                .handleInvalidTokenException(new InvalidTokenException("An error occurred"));
        ...
        assertEquals(1, body.size());
        assertEquals("An error occurred", body.get("mensaje"));
        assertEquals(403, actualHandleInvalidTokenExceptionResult.getStatusCode().value());
        assertEquals(HttpStatus.FORBIDDEN, statusCode);
        assertTrue(actualHandleInvalidTokenExceptionResult.hasBody());
        assertTrue(actualHandleInvalidTokenExceptionResult.getHeaders().isEmpty());
    }
    ...
    void testHandleInvalidTokenException2() {
        ...
        ResponseEntity<Map<String, String>> actualHandleInvalidTokenExceptionResult = globalExceptionHandler
                .handleInvalidTokenException(ex);
